...
public enum Permission {
    ...
    KUPPI_RESCHEDULE("KUPPI:RESCHEDULE", "Reschedule kuppi sessions", "KUPPI", "RESCHEDULE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_LEAVE("KUPPI:LEAVE", "Leave kuppi sessions", "KUPPI", "LEAVE", PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_FEEDBACK("KUPPI:FEEDBACK", "Submit feedback for kuppi sessions", "KUPPI", "FEEDBACK",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_VIEW_PARTICIPANTS("KUPPI:VIEW_PARTICIPANTS", "View kuppi session participants", "KUPPI", "VIEW_PARTICIPANTS",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_VIEW_ANALYTICS("KUPPI:VIEW_ANALYTICS", "View kuppi analytics", "KUPPI", "VIEW_ANALYTICS",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_VIEW_STATS("KUPPI:VIEW_STATS", "View kuppi platform statistics", "KUPPI", "VIEW_STATS",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_ADMIN_UPDATE("KUPPI:ADMIN_UPDATE", "Admin update any kuppi session", "KUPPI", "ADMIN_UPDATE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_ADMIN_DELETE("KUPPI:ADMIN_DELETE", "Admin delete any kuppi session", "KUPPI", "ADMIN_DELETE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_PERMANENT_DELETE("KUPPI:PERMANENT_DELETE", "Permanently delete kuppi sessions", "KUPPI", "PERMANENT_DELETE",
            PermissionCategory.KUPPI_MANAGEMENT),

    // ==================== KUPPI NOTES ====================
    KUPPI_NOTE_CREATE("KUPPI_NOTE:CREATE", "Create kuppi notes", "KUPPI_NOTE", "CREATE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_READ("KUPPI_NOTE:READ", "View kuppi notes", "KUPPI_NOTE", "READ", PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_UPDATE("KUPPI_NOTE:UPDATE", "Update kuppi notes", "KUPPI_NOTE", "UPDATE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_DELETE("KUPPI_NOTE:DELETE", "Delete kuppi notes", "KUPPI_NOTE", "DELETE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_DOWNLOAD("KUPPI_NOTE:DOWNLOAD", "Download kuppi notes", "KUPPI_NOTE", "DOWNLOAD",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_SEARCH("KUPPI_NOTE:SEARCH", "Search kuppi notes", "KUPPI_NOTE", "SEARCH",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_ADMIN_UPDATE("KUPPI_NOTE:ADMIN_UPDATE", "Admin update any kuppi note", "KUPPI_NOTE", "ADMIN_UPDATE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_ADMIN_DELETE("KUPPI_NOTE:ADMIN_DELETE", "Admin delete any kuppi note", "KUPPI_NOTE", "ADMIN_DELETE",
            PermissionCategory.KUPPI_MANAGEMENT),
    KUPPI_NOTE_PERMANENT_DELETE("KUPPI_NOTE:PERMANENT_DELETE", "Permanently delete kuppi notes", "KUPPI_NOTE",
            "PERMANENT_DELETE", PermissionCategory.KUPPI_MANAGEMENT),
    ...
    CLUB_MANAGE_MEMBERS("CLUB:MANAGE_MEMBERS", "Manage club members", "CLUB", "MANAGE_MEMBERS",
            PermissionCategory.CLUB_MANAGEMENT),
    ...
    ELECTION_MANAGE("ELECTION:MANAGE", "Manage election lifecycle", "ELECTION", "MANAGE",
            PermissionCategory.VOTING_MANAGEMENT),
    ELECTION_PUBLISH_RESULTS("ELECTION:PUBLISH_RESULTS", "Publish election results", "ELECTION", "PUBLISH_RESULTS",
            PermissionCategory.VOTING_MANAGEMENT),
    ...
    BATCH_ANNOUNCE("BATCH:ANNOUNCE", "Make batch announcements", "BATCH", "ANNOUNCE",
            PermissionCategory.BATCH_MANAGEMENT),
    BATCH_COORDINATE("BATCH:COORDINATE", "Coordinate batch activities", "BATCH", "COORDINATE",
            PermissionCategory.BATCH_MANAGEMENT),
    BATCH_REPRESENT("BATCH:REPRESENT", "Represent batch to faculty", "BATCH", "REPRESENT",
            PermissionCategory.BATCH_MANAGEMENT),
    ...
    EVENT_ADMIN_UPDATE("EVENT:ADMIN_UPDATE", "Admin update any event", "EVENT", "ADMIN_UPDATE",
            PermissionCategory.EVENT_MANAGEMENT),
    EVENT_ADMIN_DELETE("EVENT:ADMIN_DELETE", "Admin delete any event", "EVENT", "ADMIN_DELETE",
            PermissionCategory.EVENT_MANAGEMENT),
    EVENT_VIEW_STATS("EVENT:VIEW_STATS", "View event platform statistics", "EVENT", "VIEW_STATS",
            PermissionCategory.EVENT_MANAGEMENT),
    EVENT_VIEW_ANALYTICS("EVENT:VIEW_ANALYTICS", "View event analytics", "EVENT", "VIEW_ANALYTICS",
            PermissionCategory.EVENT_MANAGEMENT),
    EVENT_PERMANENT_DELETE("EVENT:PERMANENT_DELETE", "Permanently delete events", "EVENT", "PERMANENT_DELETE",
            PermissionCategory.EVENT_MANAGEMENT),
    ...
    COMMUNICATION_BROADCAST("COMM:BROADCAST", "Broadcast messages", "COMM", "BROADCAST",
